...
<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ route('admin.menu.index') }}" class="btn btn-success">Danh sách menu</a>
	</div>
</div>
			...
			<form action="{{ route('admin.menu.store') }}" method="POST">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-8">
							{!! Form::select('type', $optionMenuType, old('type'), array('class' =>'form-control')) !!}
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<p>Định dạng jpg, jpeg, png. Tên thư mục & ảnh phải là tiếng việt không dấu, không chứa dấu cách + kí tự đặc biệt. Dung lượng ảnh nhẹ (< 1mb)<br>Kích cỡ: 50x50</p>
						<div class="row">
							<div class="col-sm-6">
